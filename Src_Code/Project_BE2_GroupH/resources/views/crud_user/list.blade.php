...
// use Session;
?>
<link rel="stylesheet" href="{{ asset('fe/button.css') }}">
<link rel="stylesheet" href="{{ asset('fe/btn3d.css') }}">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <li class="nav-item dropdown">
                    <a style="font-weight:bold; font-size:1.3em;" class="nav-link dropdown-toggle" id="navbarDropdown"
