    ...
    <main class="signup-form">
        <div class="cotainer">
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="card">
                        <h3 style="font-size: 1.5em; font-weight:bold;" class="text-info card-header text-center">Update User</h3>
                        <div class="card-body">
                            <form action="{{ route('user.postUpdateUser') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4" style="text-align: center">
                                        ...
                                        <p style="margin-top:28px">Nhập lại mật khẩu</p>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      ...
                                      <a style="margin-left:-90px;" href="{{ route('user.list')}}" class="btn btn-info">Quay về</a>
                                  </div>
                                </div>
